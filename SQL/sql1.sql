...
#use company;
#create table jobbs(job_id varchar(20) primary key,job_title varchar(200),min_salary int(200),max_salary int(200));
#desc jobbs;
create table dependents(dependent_id varchar(20) primary key,first_name varchar(200),last_name varchar(200),relationship varchar(200),employee_id varchar(200), foreign key (employee_id) references employees(employee_id));
#desc dependents;
create table departments(department_id varchar(200) primary key,department_name varchar(200),location_id varchar(200), foreign key (location_id) references locations (location_id));
#desc departments;
#create table regions(region_id varchar(200) primary key,region_name varchar(200));
#desc regions;
#create table countries(country_id varchar(200) primary key,country_name varchar(200), region_id varchar(50), foreign key (region_id) references regions(region_id));
#desc countries;
create table locations(location_id varchar(200) primary key,street_address varchar(200),postal_code varchar(200),city varchar(200),state_province varchar(200),country_id varchar(200),foreign key(country_id) references countries(country_id));
desc locations;
drop table locations;
create table employees(employee_id varchar(200) primary key,first_name varchar(200),last_name varchar(200),email varchar(200),phone_number varchar(200),hire_date date,job_id varchar(20), foreign key(job_id) references jobs(job_id),salary varchar(200),manager_id varchar(200),foreign key(manager_id) references employees(employee_id), department_id varchar(200),foreign key(department_id) references departments(department_id));
desc employees;
...
alter table departments modify column location_id VARCHAR(200);
DROP table jobs;
use company;
show tables;
rename table jobbs to jobs;
...
_ id) VALUES (1400,'2014 Jabberwocky Rd','26192','Southlake','Texas','US');
INSERT INTO
locations(location_id,street_address,postal_code,city,state_province,country
_ id) VALUES (1500,'2011 Interiors Blvd','99236','South San
Francisco','California','US');
INSERT INTO
locations(location_id,street_address,postal_code,city,state_province,country
_ id) VALUES (1700,'2004 Charade Rd','98199','Seattle','Washington','US');
INSERT INTO
locations(location_id,street_address,postal_code,city,state_province,country
_ id) VALUES (1800,'147 Spadina Ave','M5V 2L7','Toronto','Ontario','CA');
INSERT INTO
locations(location_id,street_address,postal_code,city,state_province,country
_ id) VALUES (2400,'8204 Arthur St',NULL,'London',NULL,'UK');
INSERT INTO
locations(location_id,street_address,postal_code,city,state_province,country
_ id) VALUES (2500,'Magdalen Centre, The Oxford Science Park','OX9
9ZB','Oxford','Oxford','UK');
INSERT INTO
locations(location_id,street_address,postal_code,city,state_province,country
_ id) VALUES (2700,'Schwanthalerstr. 7031','80925','Munich','Bavaria','DE');
...
SELECT hire_date FROM employees WHERE last_name IN ('King','Hunold');
...
insert into employees(employee_id,first_name, last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) values(207,'Paul','Newton','steven.paul@sqltutotrial.org','231','1987-06-17', 4,24000.0,NULL,11);
